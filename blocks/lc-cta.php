	...
	<div class="container py-5">
		<div class="row g-5 align-items-center">
			...
			<div class="col-md-4 d-flex flex-column align-items-center gap-3">
				<a class="button button--lg w-100 text-center d-none d-sm-inline-block" href="tel:<?= parse_phone( get_field( 'contact_phone', 'option' ) ); ?>"><i class="fa-solid fa-phone me-2"></i> Call <?= get_field( 'contact_phone', 'option' ); ?></a>
				<a class="button button--lg w-100 text-center d-sm-none" href="tel:<?= parse_phone( get_field( 'contact_phone', 'option' ) ); ?>"><i class="fa-solid fa-phone me-2"></i> Call Now</a>
