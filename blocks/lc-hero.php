	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 py-4 d-flex flex-wrap justify-content-center gap-4">
				...
				<a class="d-sm-none button button--lg has-whatsapp-background-color" href="tel:<?= parse_phone( get_field( 'contact_phone' ) ); ?>"><i class="fa-brands fa-whatsapp me-2"></i> WhatsApp Us</a>
